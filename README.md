I am a microbial ecologist by training and have always had a passion for learning about microbes in their natural environment. Microbes are everywhere, and I enjoy using different kinds of tools and approaches to understand why microbes thrive in certain environments, how microbial environments shape microbiomes, and how microbes adapt to stress. Some time during graduate school I became acquainted with bioinformatics and computer programming. Though my initial attempts to learn to code felt fairly disastrous, I was eventually able to figure out my learning style and have come to love solving problems using sequencing and programming.

In our activities, we will be programming in R and Markdown. As for me, I am proficient in R and Unix, have a working familiarity with Markdown and HTML, and know just enough python and perl to be dangerous. I believe that learning any computer language will help you to learn others, so if you have any experience with these languages, or others like java or scratch, then you’ve got a leg up. If you don’t, don’t worry! Anyone can learn, but I need you to have a growth mindset (https://www.coursera.org/articles/growth-mindset) as we face these challenges.
...
https://www.w3schools.com/r/default.asp - An R tutorial that starts from the ground floor. Hello, World!
...
R on Unity (https://docs.unity.rc.umass.edu/documentation/tools/r/) – Unity is our campus cloud computing platform, and it includes RStudio in Unity On Demand. There is also a slack channel for Unity that has a great bioinformatics group.
Stack Overflow – Tons of R questions and answers. When you google an error code (which you should do if the documentation fails to resolve your issue), turn to Stack Overflow first. It is one of the least toxic online R programming message boards.
